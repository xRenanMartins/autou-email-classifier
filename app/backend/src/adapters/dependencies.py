...
from ..core.ports import (
    ...
    EmailRepositoryPort, TemplateRepositoryPort,
    NotificationPort, SecurityPort, CachePort
)
from .gateways import (
    TextEmailParser, FileEmailParser, HeuristicClassifier,
    TemplateResponder, InMemoryEmailRepository, InMemoryTemplateRepository,
