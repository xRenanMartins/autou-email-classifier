...
from ...core.application.use_cases import (
    ProcessEmailUseCase, GetEmailClassificationUseCase,
    GetProcessingStatsUseCase, GetSupportedLabelsUseCase,
    HealthCheckUseCase
)
from ...core.application.dto import (
    EmailProcessingRequest, EmailProcessingResponse,
    ErrorResponse, RateLimitResponse, HealthCheckResponse
)
...
class EmailClassificationController:
    ...
    async def get_supported_labels(
        ...
        """
        try:
            use_case = GetSupportedLabelsUseCase(
                classifier=deps["classifier"]
            )
