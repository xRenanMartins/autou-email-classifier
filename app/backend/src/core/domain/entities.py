...
class Email:
    ...
    def is_processed(self) -> bool:
        ...
        return (
            self._preprocessed is not None and
            self._classification is not None and
            self._suggested_response is not None
        )
    ...
    def get_processing_summary(self) -> dict:
        ...
        return {
            ...
            "classification": self._classification.label.value if self._classification else None,
            "confidence": self._classification.confidence if self._classification else None,
...
class ResponseTemplate:
    ...
    def is_compatible_with(self, email: Email) -> bool:
        ...
        return (
            self.label_target == email._classification.label and
            self.language == (email._preprocessed.language if email._preprocessed else "pt") and
            self.is_active
        )
