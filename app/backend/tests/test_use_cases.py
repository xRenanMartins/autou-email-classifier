...
from src.core.domain.entities import Email, EmailLabel
...
class TestClassifyEmailAndSuggestResponse:
    ...
    def test_classify_email_with_both_text_and_file(self, mock_classifier, mock_responder):
    ...
    def test_classify_email_classification_failure(self, mock_responder):
        ...
        request = {
            "text": "Email de teste com texto suficiente para validação."
        }
    ...
    def test_classify_email_response_generation_failure(self, mock_classifier):
        ...
        mock_responder = Mock()
        mock_responder.suggest_reply.side_effect = Exception("Response generation failed")
