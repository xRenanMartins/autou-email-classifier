import pytest
from src.core.domain.services import EmailPreprocessingService, EmailClassificationService
from src.core.domain.entities import Email, PreprocessedEmail, EmailLabel, Classification
...
class TestEmailClassificationService:
    ...
    def test_classify_email_with_keywords(self):
        ...
        preprocessed = PreprocessedEmail(
            ...
            tokens=["solicito", "análise", "relatório", "revisão", "contrato", "aprovação", "orçamento"],
            language="pt",
            word_count=7,
            has_attachments=False
        )
